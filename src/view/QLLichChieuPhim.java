...
//    }
    ...
    public QLLichChieuPhim() {
       ...
       //set màu cho table
        ...
        loadComboboxData(cbb_MaPhim, cbb_MaRap);
    ...
    public void loadComboboxData(JComboBox cbbMaPhim, JComboBox cbbMaRap){
        ArrayList<Phim> allPhim = Phim_ctrl.getAll();
        List<String> allMaRap = SuatChieu_ctrl.getAllMaRap();
        
        for(Phim phim : allPhim){
            cbbMaPhim.addItem((String) phim.getMaPhim());
        }
        
        for(String marap : allMaRap){
            cbbMaRap.addItem( marap);
        }
    }
    ...
    private void initComponents() {
        ...
        cbb_MaRap = new javax.swing.JComboBox<>();
        ...
        cbb_MaRap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbb_MaRapActionPerformed(evt);
            }
        });
        jPanel1.add(cbb_MaRap);
        cbb_MaRap.setBounds(130, 230, 290, 30);

        cbb_MaPhim.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbb_MaPhimActionPerformed(evt);
            }
        });
        jPanel1.add(cbb_MaPhim);
        cbb_MaPhim.setBounds(130, 280, 290, 30);
    ...
    private void button_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_themActionPerformed
        try {
            ...
            sc.setMaRap((String) cbb_MaRap.getSelectedItem());
            sc.setMaPhim((String) cbb_MaPhim.getSelectedItem());
    ...
    private void button_tracuu1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_tracuu1ActionPerformed
        cbb_MaRap.setSelectedIndex(0);
        txt_Time.setText("");
        day_NgayChieu.setDate(null);
        cbb_MaPhim.setSelectedIndex(0);
        txt_maSC.setText("");
    ...
    private void table_SUATCHIEUMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_SUATCHIEUMouseClicked
        ...
        cbb_MaRap.setSelectedItem(model.getValueAt(i, 1).toString());
        cbb_MaPhim.setSelectedItem(model.getValueAt(i, 2).toString());
        try {
    ...
    private void cbb_MaRapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbb_MaRapActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbb_MaRapActionPerformed

    private void cbb_MaPhimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbb_MaPhimActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbb_MaPhimActionPerformed
...
//    } 
    ...
    private javax.swing.JComboBox<String> cbb_MaRap;
